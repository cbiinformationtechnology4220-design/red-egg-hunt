...
describe('frontend accessibility and responsive contracts', () => {
  it('has labeled public and staff controls, focus treatment, reduced motion, and no emojis', async () => {
    ...
    expect(app).toContain('red-egg-deli-walking-mascots.png');
    expect(app).toContain('red-egg-deli-skate-mascot.png');
    expect(css).toContain('.detail-icon-wrap');
    expect(css).toContain('.menu-card-icon');
    expect(css).toContain('.footer-contact');
    expect(css).toContain('.deli-mascot-walking');
    expect(css).toContain('.menu-mascot');
    ...
    expect(css).toContain('@keyframes mascot-walk');
    expect(css).toContain('@keyframes skate-float');
